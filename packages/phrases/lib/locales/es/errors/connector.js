const connector = {
    ...
    template_not_found: 'No se puede encontrar la plantilla correcta en la configuración del conector.',
    ...
    social_auth_code_invalid: 'No se puede obtener el token de acceso, por favor revise el código de autorización.',
    ...
    more_than_one_connector_factory: 'Se encontraron múltiples fábricas de conectores (con ID {{connectorIds}}), puede desinstalar las innecesarias.',
    db_connector_type_mismatch: 'Hay un conector en la base de datos que no coincide con el tipo.',
    not_found_with_connector_id: 'No se puede encontrar el conector con el ID estándar de conector proporcionado.',
    multiple_instances_not_supported: 'No se pueden crear múltiples instancias con el conector estándar seleccionado.',
    invalid_type_for_syncing_profile: 'Solo puede sincronizar el perfil de usuario con conectores sociales.',
    can_not_modify_target: "No se puede modificar el 'objetivo' del conector.",
    should_specify_target: "Debe especificar el 'objetivo'.",
    multiple_target_with_same_platform: 'No puede tener múltiples conectores sociales que tengan el mismo objetivo y plataforma.',
    cannot_overwrite_metadata_for_non_standard_connector: "Los 'metadatos' de este conector no se pueden sobrescribir.",
};
