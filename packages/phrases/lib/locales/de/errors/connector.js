const connector = {
    ...
    insufficient_request_parameters: 'Die Anfrage enthält möglicherweise nicht alle erforderlichen Eingabeparameter.',
    invalid_config: 'Die Konfiguration des Connectors ist ungültig.',
    invalid_response: 'Die Antwort des Connectors ist ungültig.',
    template_not_found: 'Die richtige Vorlage in der Connector-Konfiguration konnte nicht gefunden werden.',
    ...
    social_auth_code_invalid: 'Es konnte kein Access Token abgerufen werden. Bitte prüfen Sie den Autorisierungscode.',
    ...
    more_than_one_connector_factory: 'Mehrere Connector-Fabriken gefunden (mit ID {{connectorIds}}). Sie können unnötige Fabriken deinstallieren.',
    db_connector_type_mismatch: 'Es gibt einen Connector in der Datenbank, der nicht dem Typ entspricht.',
    not_found_with_connector_id: 'Connector mit der angegebenen Standard-Connector-ID konnte nicht gefunden werden.',
    multiple_instances_not_supported: 'Es können keine mehreren Instanzen mit dem ausgewählten Standard-Connector erstellt werden.',
    invalid_type_for_syncing_profile: 'Sie können nur Benutzerprofile mit sozialen Connectors synchronisieren.',
    ...
    multiple_target_with_same_platform: 'Sie können keine mehreren sozialen Connectors haben, die das gleiche Ziel und die gleiche Plattform haben.',
    cannot_overwrite_metadata_for_non_standard_connector: "Die 'Metadaten' dieses Connectors können nicht überschrieben werden.",
};
