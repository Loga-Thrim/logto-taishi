...
export const getAlterationFiles = async () => {
    ...
    const localAlterationDirectory = path.resolve(packageDirectory ?? currentDirname, 'alteration-scripts');
...
export const chooseRevertAlterationsByTimestamp = async (target) => {
