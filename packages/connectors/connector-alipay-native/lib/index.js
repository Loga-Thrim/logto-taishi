...
const authorizationEndpoint = 'alipay://'; // This is used to arouse the native Alipay App
...
const alipayNativeConfigGuard = z.object({
...
const createAlipayNativeConnector = async ({ getConfig }) => {
    return {
...
export { createAlipayNativeConnector as default, getAccessToken };
