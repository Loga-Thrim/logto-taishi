...
const authorizationEndpoint = 'wechat://'; // This is used to arouse the native WeChat App
...
const wechatNativeConfigGuard = z.object({
    appId: z.string(),
    appSecret: z.string(),
...
const createWechatNativeConnector = async ({ getConfig }) => {
    return {
...
export { createWechatNativeConnector as default, getAccessToken };
