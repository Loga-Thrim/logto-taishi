...
import { expectToClickDetailsPageOption, expectUnsavedChangesAlert, goToAdminConsole, expectToSaveChanges, waitForToast, expectModalWithTitle, } from '#src/ui-helpers/index.js';
import { expectNavigation, appendPathname } from '#src/utils.js';
import { expectToConfirmConnectorDeletion, expectToSelectConnector, waitForConnectorCreationGuide, } from './helpers.js';
import { socialConnectorTestCases, } from './social-connector-test-cases.js';
...
describe('social connectors', () => {
    ...
    it.each(socialConnectorTestCases)('can create and modify a(n) $factoryId social connector', async ({ groupFactoryId, factoryId, name, initialFormData, updateFormData, errorFormData, standardBasicFormData, }) => {
...
//# sourceMappingURL=social-connectors.test.js.map