...
import { expectToClickNavTab, goToAdminConsole, expectToSaveChanges, } from '#src/ui-helpers/index.js';
import { expectNavigation, appendPathname } from '#src/utils.js';
import { expectToSaveSignInExperience, waitForFormCard } from '../helpers.js';
import { expectToDeletePasswordlessConnector, expectToSetupPasswordlessConnector, testSendgridConnector, testTwilioConnector, } from './connector-setup-helpers.js';
import { expectToSelectSignUpIdentifier, expectNotificationInFiled, expectSignUpIdentifierSelectorError, expectToAddSignInMethod, expectSignInMethodError, expectErrorsOnNavTab, expectToClickSignUpAuthnOption, expectToClickSignInMethodAuthnOption, expectToResetSignUpAndSignInConfig, } from './helpers.js';
describe('sign-in experience(sad path): sign-up and sign-in', () => {
    ...
    describe('cases that only Email connector is setup', () => {
        beforeAll(async () => {
            ...
            await expectNavigation(page.goto(appendPathname('/console/sign-in-experience/sign-up-and-sign-in', logtoConsoleUrl).href));
        });
        afterAll(async () => {
