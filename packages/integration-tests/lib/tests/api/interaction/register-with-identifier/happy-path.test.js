...
import { sendVerificationCode, putInteraction, deleteUser, patchInteractionIdentifiers, putInteractionProfile, patchInteractionProfile, deleteInteractionProfile, putInteractionEvent, } from '#src/api/index.js';
...
import { enableAllVerificationCodeSignInMethods, enableAllPasswordSignInMethods, } from '#src/helpers/sign-in-experience.js';
...
describe('register with passwordless identifier', () => {
    ...
    it('register with exiting email', async () => {
        const { user, userProfile: { primaryEmail }, } = await generateNewUser({ primaryEmail: true });
        await enableAllVerificationCodeSignInMethods({
            identifiers: [SignInIdentifier.Email],
            password: false,
            verify: true,
    ...
    it('register with exiting phone', async () => {
        const { user, userProfile: { primaryPhone }, } = await generateNewUser({ primaryPhone: true });
        await enableAllVerificationCodeSignInMethods({
            identifiers: [SignInIdentifier.Phone],
            password: false,
            verify: true,
