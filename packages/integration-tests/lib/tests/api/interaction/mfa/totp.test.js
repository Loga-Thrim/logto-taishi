...
import { putInteraction, deleteUser, initTotp, putInteractionBindMfa, putInteractionMfa, } from '#src/api/index.js';
import { initClient, processSession, logoutClient } from '#src/helpers/client.js';
import { expectRejects } from '#src/helpers/index.js';
import { enableAllPasswordSignInMethods, enableMandatoryMfaWithTotp, } from '#src/helpers/sign-in-experience.js';
...
describe('register with mfa (mandatory TOTP)', () => {
    ...
    it('should fail with wrong totp code', async () => {
        ...
        await expectRejects(client.send(putInteractionBindMfa, {
            type: MfaFactor.TOTP,
            code: '123456',
        }), {
