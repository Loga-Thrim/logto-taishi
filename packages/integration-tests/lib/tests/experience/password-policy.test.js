...
describe('password policy', () => {
    ...
    it('should work for username + password', async () => {
        ...
        await experience.toFillNewPasswords(...invalidPasswords, [username + 'A', /product context .* personal information/], username + 'ABCD_ok');
    ...
    it('should work for email + password', async () => {
        ...
        await experience.toFillNewPasswords(...invalidPasswords, [emailName, 'personal information'], emailName + 'ABCD@# $');
        await experience.verifyThenEnd();
    });
    it('should work for forgot password', async () => {
        ...
        await experience.toFillNewPasswords(...invalidPasswords, [emailName, 'personal information'], [emailName + 'ABCD@# $', 'be the same as'], emailName + 'ABCD135');
...
//# sourceMappingURL=password-policy.test.js.map