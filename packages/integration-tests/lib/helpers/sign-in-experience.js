...
export const enableAllPasswordSignInMethods = async (signUp = defaultSignUpMethod) => updateSignInExperience({
...
export const enableAllVerificationCodeSignInMethods = async (signUp = defaultSignUpMethod) => updateSignInExperience({
    signInMode: SignInMode.SignInAndRegister,
    signUp,
    signIn: {
...
export const enableMandatoryMfaWithTotp = async () => updateSignInExperience({
    mfa: {
