...
var alteration = {
    up: function (pool) { return __awaiter(void 0, void 0, void 0, function () {
        var resourceId, roleId, createAffiliateId, manageAffiliateId;
    ...
    down: function (pool) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.query((0, slonik_1.sql)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      delete from scopes\n      where tenant_id = ", " and name = any(array['create:affiliate', 'manage:affiliate']);\n    "], ["\n      delete from scopes\n      where tenant_id = ", " and name = any(array['create:affiliate', 'manage:affiliate']);\n    "])), adminTenantId))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
