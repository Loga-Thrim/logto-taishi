...
var alteration = {
    ...
    down: function (pool) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.query((0, slonik_1.sql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["drop table tenants;"], ["drop table tenants;"]))))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
